        ...
        <header className="bg-white/5 w-full h-[116px] max-[450px]:h-[70.03px] border-b-white/25 border-b-[.3px] relative">
          <Link href="/">
            <Image
              ...
              width={157}
              height={54}
              className="relative max-[450px]:w-[99.78px] ml-[300px] max-[450px]:ml-[20px] top-1/2 translate-y-[-50%] inline md_screen_max"
            />
          </Link>
          <NavLink href="/about">
            <h1 className="font-[181] text-[23px] text-[#A1E5D5] relative inline pr-[30px] top-[32px] left-[80px] hover:opacity-70 duration-[.4s] max-[450px]:text-[13px] max-[450px]:left-[30px] max-[450px]:pr-[15px] max-[450px]:top-[19px]">
          ...
          <NavLink href="/contact">
            <h1 className="font-[181] text-[23px] text-[#A1E5D5] relative inline top-[32px] left-[80px] hover:opacity-70 duration-[.4s] max-[450px]:text-[13px] max-[450px]:left-[30px] max-[450px]:top-[19px]">
              contact
            </h1>
          </NavLink>
          <Link href="/signup">
