  ...
  return (
    <main className="selection:bg-white selection:text-black">
      ...
      <section className="relative top-[55px]">
        <h1 className="text-[72px] font-bold relative left-[86px] w-fit [@media(max-width:500px)]:text-[30px]  [@media(min-width:500px)]:text-[50px] [@media(min-width:660px)]:text-[58px] [@media(min-width:1050px)]:text-[72px] [@media(max-width:1050px)]:left-[50px] [@media(max-width:660px)]:left-1/2 [@media(max-width:660px)]:translate-x-[-50%]">
          BEST COMMUNITY
        </h1>
        ...
        <Image
          className="absolute top-4 [@media(max-width:650px)]:top-[370px] w-[500px] right-14 [@media(max-width:650px)]:left-1/2 [@media(max-width:650px)]:translate-x-[-50%] [@media(max-width:1215px)]:w-[300px] [@media(max-width:1050px)]:w-[250px] [@media(max-width:760px)]:w-[200px] [@media(max-width:725px)]:w-[250px] [@media(max-width:1140px)]:top-[120px] [@media(max-width:500px)]:top-[280px]"
